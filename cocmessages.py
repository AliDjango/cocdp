...
#               fields[17], fields[18])
    ...
    24101:{"name":"OwnHomeData",
        ...
        "fields":{
            "6.253":"? ? userid json shieldtime ? ? ? userid1 userid2 ? () ? ? ? ? ? username facebookid stars points diamonds diamonds2 ? ? trophies ? ? ? ? ? ? ? ? () ? ? resources []", #" units [] spells [] unit_upgrades [] spell_upgrades [] hero_upgrades [] hero_health [] hero_state [] alliance_units [] ? [] ? [] achievements [] npcprogress [] npc_gold [] npc_elixir []",
            "6.322":"? ? timestamp ? userid json shieldtime ? ? ? userid1 userid2 ? () ? () ? () ? ? ? ? ? username facebookid stars points diamonds diamonds2 ? ? trophies ? ? ? ? ? ? ? ? () ? ? ? resources []", # " units [] spells [] unit_upgrades [] spell_upgrades [] hero_upgrades [] hero_health [] hero_state [] alliance_units [] ? [] ? [] achievements [] npcprogress [] npc_gold [] npc_elixir []",
            "6.407":"? ? timestamp ? userid shieldtime ? ? ? compressed ? userid1 userid2 ? () ? () ? () ? ? ? ? ? username facebookid stars points diamonds diamonds2 ? ? trophies ? ? ? ? ? ? ? ? () ? ? ? resources []", # " units [] spells [] unit_upgrades [] spell_upgrades [] hero_upgrades [] hero_health [] hero_state [] alliance_units [] ? [] ? [] achievements [] npcprogress [] npc_gold [] npc_elixir []",
            "7.001":"? ? timestamp ? userid shieldtime ? ? ? compressed ? userid1 userid2 clan (id name badge ? level) ? () ? () ? ? ? alliance_units_count townhall_level username facebookid stars points diamonds diamonds2 ? ? trophies attacks_won attacks_lost defenses_won defenses_lost ? ? ? ? () ? ? ? ? storage [storage capacity] resources [resource quantity] units [unit quantity] spells [spell quantity] unit_upgrades [unit level] spell_upgrades [spell level] hero_upgrades [hero level] hero_health [hero health] hero_state [hero state] alliance_units [unit quantity level] tutorial_progress [] achievements [achievement] achievement_progress [achievement progress] npc_progress [] npc_gold [] npc_elixir []",
        },
    },
    ...
    24107:{"name":"EnemyHomeData",
            ...
            "fields":{
                "7.001":"? ? timestamp ? userid shieldtime ? ? ? compressed ? userid1 userid2 clan (id name badge ? level) ? () ? () ? ? ? alliance_units_count townhall_level username facebookid stars points diamonds diamonds2 ? ? trophies attacks_won attacks_lost defenses_won defenses_lost ? ? ? ? () ? ? ? ? storage [storage capacity] resources [resource quantity] units [unit quantity] spells [spell quantity] unit_upgrades [unit level] spell_upgrades [spell level] hero_upgrades [hero level] hero_health [hero health] hero_state [hero state] alliance_units [unit quantity level] tutorial_progress [] achievements [achievement] achievement_progress [achievement progress] npc_progress [] npc_gold [] npc_elixir [] ownhomedata {? userid1 userid2 clan (id name badge ? level) ? () ? () ? ? ? alliance_units_count townhall_level username facebookid stars points diamonds diamonds2 ? ? trophies attacks_won attacks_lost defenses_won defenses_lost ? ? ? ? () ? ? ? ? storage [storage capacity] resources [resource quantity] units [unit quantity] spells [spell quantity] unit_upgrades [unit level] spell_upgrades [spell level] hero_upgrades [hero level] hero_health [hero health] hero_state [hero state] alliance_units [unit quantity level] tutorial_progress [] achievements [achievement] achievement_progress [achievement progress] npc_progress [] npc_gold [] npc_elixir []}",
            }
    },
    ...
    24113:{"name":"VisitedHomeData", "format":{
        ...
        "fields":{
            "7.001":"? ? userid shieldtime ? ? ? compressed ? userid1 userid2 clan (id name badge ? level) ? () ? () ? ? ? alliance_units_count townhall_level username facebookid stars points ? ? ? ? trophies attacks_won ? defenses_won ? ? ? ? ? () ? ? ? ? storage [storage capacity] resources [resource quantity] units [unit quantity] spells [spell quantity] unit_upgrades [unit level] spell_upgrades [spell level] hero_upgrades [hero level] hero_health [hero health] hero_state [hero state] alliance_units [unit quantity level] tutorial_progress [] achievements [achievement] achievement_progress [achievement progress] npc_progress [] npc_gold [] npc_elixir [] ? [] ownhomedata {? ? userid1 userid2 clan (id name badge ? level) ? () ? () ? ? ? alliance_units_count townhall_level username facebookid stars points diamonds diamonds2 ? ? trophies attacks_won attacks_lost defenses_won defenses_lost ? ? ? ? () ? ? ? ? storage [storage capacity] resources [resource quantity] units [unit quantity] spells [spell quantity] unit_upgrades [unit level] spell_upgrades [spell level] hero_upgrades [hero level] hero_health [hero health] hero_state [hero state] alliance_units [unit quantity level] tutorial_progress [] achievements [achievement] achievement_progress [achievement progress] npc_progress [] npc_gold [] npc_elixir []}",
        }
    },
